...
\newcommand{\ProblemPts}{
    \hrulefill \textcolor{black}{\large $\mathbf{\Sigma}$ Problem: \textbf{\arabic{ProblemPoints}\,P.}}\\[2ex]
    \setcounter{PartialPoints}{0}
    \setcounter{ProblemPoints}{0}
}
\newcommand{\TotalPts}{
    \hfill \fbox{\textcolor{black}{\Large Total Score: \textbf{\arabic{TotalPoints}\,P.}}}
}
...
\textbf{\large  __VERSUCH__ (__SEMESTER__)}
